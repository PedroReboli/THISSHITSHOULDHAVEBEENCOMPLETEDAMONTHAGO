...
func newEvent(db *gorm.DB, opts ...gen.DOOption) event {
	...
	_event.Begindate = field.NewTime(tableName, "begindate")
	_event.Enddate = field.NewTime(tableName, "enddate")
	_event.Details = field.NewString(tableName, "details")
	_event.Architect = field.NewInt32(tableName, "architect")
...
type event struct {
	...
	ID        field.Int32
	Name      field.String
	Begindate field.Time
	Enddate   field.Time
	Details   field.String
	Architect field.Int32
...
func (e *event) updateTableName(table string) *event {
	...
	e.Begindate = field.NewTime(table, "begindate")
	e.Enddate = field.NewTime(table, "enddate")
	e.Details = field.NewString(table, "details")
	e.Architect = field.NewInt32(table, "architect")
...
func (e *event) fillFieldMap() {
	...
	e.fieldMap["begindate"] = e.Begindate
	e.fieldMap["enddate"] = e.Enddate
	e.fieldMap["details"] = e.Details
	e.fieldMap["architect"] = e.Architect
}
